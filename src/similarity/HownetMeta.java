...
public interface HownetMeta {	
	...
	/** γ：具体词与义元的相似度一律为�?��较小的常�?*/
	public static final double gamma = 0.2; 
	
	/** δ:任一个非空�?与空值的相似度为�?��较小的常数，此处�?.2 */
	...
	/** 
	 * Θ 计算后面概念的义原与参照概念�?��义原的最大相似度, 并乘以两个概念主义原相似度的�?主义原�?过该方式起约束作�?,
	 * 如果数�?大于该�?时才会起参照作用, 去掉冗余的不重要义原 
	 */
	public static final double PARAM_THETA = 0.5;
	/** 
	 * Ω 计算前面概念的义原与参照概念�?��义原的最大相似度，并乘以两个概念主义原相似度的积(主义原�?过该方式起约束作�?,
	 * 如果数�?大于该�?时才会调整前面概念的义原符号, 以起修正作用
	 */
